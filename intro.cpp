...
int main()
{
   ...
   // box(mainwin, 0, 0);
    ...
    mvwprintw(dialogue, 13, 10, "You can make 999 movements at maximum, use them wisely!");
    mvwprintw(dialogue, 14, 10, "If you hit borders or obstacles, one of your hearts is gone");
    mvwprintw(dialogue, 15, 10, "Game ends when quantity of hearts reaches 0 or you reach movement limit!");
    mvwprintw(dialogue, 16, 10, "Are you ready? (y/n)");
    ...
    wrefresh(mainwin);      // Refresh mainwin to clear the previous text
